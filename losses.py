...
# class UniConLoss(nn.Module):
#     def __init__(self, temperature=0.1, contrast_mode='all', base_temperature=0.1, class_weights=None):
#         super(UniConLoss, self).__init__()
#         self.temperature = temperature
#         self.contrast_mode = contrast_mode
#         self.base_temperature = base_temperature
...
#             weights = self.class_weights[labels.view(-1)].to(device)
#             if anchor_count > 1:
...
#Improved version of UniConLoss
class UniConLoss(nn.Module):
